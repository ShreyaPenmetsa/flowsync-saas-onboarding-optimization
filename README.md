# FlowSync — SaaS User Onboarding Optimization

## Problem
New users signing up for a SaaS product were dropping off before reaching activation, reducing retention and lifetime value.

## Approach
- Conducted user research to understand friction points in the onboarding flow
- Mapped the end-to-end customer journey from signup to activation
